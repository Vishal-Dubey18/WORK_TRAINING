...
TIME_DELAY_BETWEEN_ALERTS = 5  # Cooldown period in seconds
LAST_ALERT_TIME = 0
last_reported = {}
...
while True:
    ...
    for encodeFace, faceLoc in zip(encodesCurFrame, facesCurFrame):
        ...
        if matches[matchIndex] and faceDis[matchIndex] < DETECTION_THRESHOLD:
            ...
            encoding_tuple = tuple(unknown_encoding)
            ...
            if not duplicate:
                ...
                if filename:
                    ...
                    last_reported[encoding_tuple] = current_time
            else:
                if encoding_tuple not in last_reported or (current_time - last_reported[encoding_tuple] > TIME_DELAY_BETWEEN_ALERTS):
